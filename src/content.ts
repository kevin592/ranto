...
const en = {
  ...
  manifesto: 'The quiet standard, held without compromise.',
  homeIndexLabel: 'THE RANTO SYSTEM',
  homeChapterLines: ['Born in professional scenes where cleanliness is part of the experience.', 'A documented chain from specification to traceable release.', 'Six care systems, translated for intuitive daily use.', 'One disciplined identity, adapted responsibly for every market.'],
  storyIntro: 'RANTO began behind the doors of environments where cleanliness is never optional: boutique hotels, culinary spaces and premium residences. In these places, care is invisible when done well, and immediately visible when it is not. That standard, repeated daily under real conditions, is the discipline we now bring to every home.',
  labBody: 'Every formula is reviewed for material compatibility: surfaces, fabrics, seals and routine contact. Appearance, odour, pH and functional performance are checked against specification before any batch moves forward.',
  offlineBody: 'Trust grows where products can be picked up, compared and asked about. RANTO works with offline retail that treats household care as a considered purchase, not a commodity aisle.',
  hospitalityBody: 'In hotels and professional spaces, results are repeated daily, not demonstrated once. These are the routines our products were forged in.',
  nextLabel: 'NEXT CHAPTER',
  qualityFeatureTitle: 'Every bottle passes through the same discipline.',
  productRituals: ['Sort, soak, spin. The routine stays the same, and the fabric remembers it.', 'Spray, wait a moment, wipe. Grease lifts without a fight.', 'A gentle pass over tile and fixture. Rinse, and the room resets.', 'One calm weekly pass over the surfaces you live with.', 'Brush away the day. Care for the material that carries you.', 'One pod, one load. Pre-measured, so your hands never guess.'],
...
const zh = {
  ...
  manifesto: '安静的标准，从不妥协。',
  homeIndexLabel: 'RANTO 体系',
  homeChapterLines: ['诞生于把清洁视为体验一部分的专业场景。', '一条从规格到可追溯放行的完整控制链。', '六大护理系统，转化为直观的日常使用。', '一个克制的品牌身份，负责任地适应每个市场。'],
  storyIntro: 'RANTO 起步于那些不允许清洁出错的环境：精品酒店、餐饮空间与高端住宅。在这些地方，做得好的护理是无形的，做得不好则一眼可见。这套在真实条件下日复一日打磨出的标准，如今被我们带进每一个家庭。',
  labBody: '每一个配方都会针对材质适配进行审查：表面、织物、密封件与日常接触。外观、气味、pH 与功能表现均须符合规格，批次才能流向下一环节。',
  offlineBody: '信任在能够亲手拿起、比较与询问的地方生长。RANTO 只与把家居护理视为认真决策、而非货架杂货的线下渠道合作。',
  hospitalityBody: '在酒店与专业场景中，效果是每天重复出来的，不是一次演示出来的。这正是我们的产品被锻造出来的地方。',
  nextLabel: '下一章节',
  qualityFeatureTitle: '每一瓶，都经过同一套纪律。',
  productRituals: ['分拣、浸泡、脱水。流程不变，织物自会记得这份照料。', '喷上，稍候片刻，一擦即净。油污无需费力对抗。', '轻轻掠过瓷砖与五金，冲净之后，卫浴焕然一新。', '每周一次，温和打理朝夕相处的每一处表面。', '刷去一天的痕迹，也照顾承载你行走的材质。', '一颗凝珠，一次洗涤。预先定量，双手无需猜测。'],
...
const ja = {
  ...
  manifesto: '静かな基準、妥協なき積み重ね。',
  homeIndexLabel: 'RANTO の体系',
  homeChapterLines: ['清潔さが体験の一部である現場から生まれた。', '仕様から追跡可能な出荷まで、記録された鎖。', '直感的に使える6つのケアシステム。', '責任をもって各市場へ適応する、ひとつの規律。'],
  storyIntro: 'RANTOは、清潔さが前提となる場所から始まりました。ブティックホテル、料理空間、上質な住環境。そこでは、良いケアは目に留まらず、手を抜けばすぐに見えます。実際の現場で毎日繰り返されたその基準を、今はすべての家庭へ届けています。',
  labBody: 'すべての処方は素材適合性を確認します。表面、布、密封部、そして日常の触れ合い。外観、香り、pH、機能が仕様どおりでなければ、ロットは次へ進みません。',
  offlineBody: '信頼は、手に取り、比べ、尋ねられる場所で育ちます。RANTOは、家庭のケアを消耗品ではなく選択の対象として扱う店舗とともにいます。',
  hospitalityBody: 'ホテルやプロの現場では、結果は一度のデモではなく毎日の積み重ねです。製品が鍛えられたのは、まさにその現場です。',
  nextLabel: '次の章',
  qualityFeatureTitle: 'どのボトルも、同じ規律を通る。',
  productRituals: ['分けて、浸して、脱水する。変わらぬ手順が、生地を静かに整える。', '吹きかけて、少し待ち、ひと拭き。油汚れは静かに離れる。', 'タイルと金具をやさしくなでて、流す。空間がリセットされる。', '毎週一度、暮らしの表面を静かに丁寧に。', '一日の汚れを落とし、歩む素材をいたわる。', '1つのポッドで1回分。計る手間を、ゼロにする。'],
...
const th = {
  ...
  manifesto: 'มาตรฐานที่เงียบ แต่ไม่เคยประนีประนอม',
  homeIndexLabel: 'ระบบของ RANTO',
  homeChapterLines: ['กำเนิดจากสถานที่ที่ความสะอาดคือส่วนหนึ่งของประสบการณ์', 'ห่วงโซ่ที่บันทึกตั้งแต่ข้อกำหนดจนถึงการปล่อยล็อตที่ตรวจย้อนกลับได้', 'ระบบดูแล 6 หมวด แปลงให้ใช้งานได้ง่ายทุกวัน', 'อัตลักษณ์เดียวที่ปรับให้เหมาะกับทุกตลาดอย่างรับผิดชอบ'],
  storyIntro: 'RANTO เริ่มต้นในสถานที่ที่ความสะอาดห้ามพลาด โรงแรมบูทีค พื้นที่อาหาร และที่พักระดับพรีเมียม ในที่เหล่านั้น การดูแลที่ดีมองไม่เห็น แต่ถ้าพลาดจะเห็นได้ทันที มาตรฐานที่ฝึกฝนมาทุกวันในเงื่อนไขจริง คือสิ่งที่เรานำมามอบให้ทุกบ้าน',
  labBody: 'ทุกสูตรถูกตรวจสอบความเข้ากันได้ของวัสดุ ทั้งพื้นผิว ผ้า ส่วนปิดผนึก และการสัมผัสในชีวิตประจำวัน ลักษณะ กลิ่น pH และประสิทธิภาพต้องตรงตามข้อกำหนด ล็อตจึงจะไปต่อได้',
  offlineBody: 'ความไว้ใจเติบโตในที่ที่หยิบจับ เปรียบเทียบ และถามได้จริง RANTO ทำงานกับร้านค้าที่มองการดูแลบ้านเป็นการตัดสินใจอย่างรอบคอบ ไม่ใช่สินค้าชำทั่วไป',
  hospitalityBody: 'ในโรงแรมและพื้นที่มืออาชีพ ผลลัพธ์ต้องทำซ้ำทุกวัน ไม่ใช่สาธิตครั้งเดียว นี่คือกิจวัตรที่ผลิตภัณฑ์ของเราถูกหล่อหลอม',
  nextLabel: 'บทถัดไป',
  qualityFeatureTitle: 'ขวดทุกใบ ผ่านวินัยเดียวกัน',
  productRituals: ['แยก แช่ หมุนฟอก กิจวัตรเดิมที่ผ้าจะจดจำ', 'ฉีด รอสักครู่ แล้วเช็ด คราบมันเขินหนีไปเอง', 'เช็ดเบา ๆ บนกระเบื้องและอุปกรณ์ ล้างน้ำแล้วห้องกลับมาสะอาด', 'สัปดาห์ละครั้ง ดูแลพื้นผิวที่คุณอยู่ด้วยอย่างอ่อนโยน', 'แปรงความเป็นวันออกไป ดูแลวัสดุที่พาคุณเดิน', 'หนึ่งพ็อด ต่อหนึ่งรอบ ปริมาณพอดี ไม่ต้องกะ'],
